...
- [ ] **`docs/handoffs/Phase_9_Character_Generation_UI.md`** — carried forward from Phase 9, still open. Chargen-time Character Framework display, Resonance selection, Skill allocation, and B&B selection (REQ-011).
